...
public class LoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    private void verifyFromSQLite()
    {
        ...
        if(myDB.checkPatient(textInputEditTextEmail.getText().toString().trim(), textInputEditTextPassword.getText().toString().trim()))
        {
        ...
        {
            Snackbar.make(nestedScrollView, getString(R.string.error_invalid_login), Snackbar.LENGTH_LONG).show();
        }
    }
